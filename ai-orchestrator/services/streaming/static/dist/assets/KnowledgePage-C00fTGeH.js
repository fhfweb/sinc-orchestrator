import{a as U,o as A,e as d,f as c,g as e,t as i,q as f,v as h,F as S,s as z,m as G,n as w,r as l,c as j}from"./vendor-ZjHzkyv6.js";import{u as M}from"./useApi-DHBpucMU.js";import{u as O,_ as F}from"./index-BnkmTiOj.js";const N={class:"knowledge-page"},V={class:"page-header flex items-center justify-between"},B=["disabled"],I={class:"split-layout"},K={class:"card doc-list-panel"},Q={class:"doc-items"},E=["onClick"],J={class:"doc-item-title truncate"},W={class:"doc-item-meta flex items-center justify-between"},$={class:"badge badge-info"},H={class:"flex items-center gap-2"},Y=["title"],X={class:"text-muted",style:{"font-size":".7rem"}},Z={class:"text-muted",style:{"font-size":".7rem"}},ee={key:0,class:"text-muted",style:{padding:".75rem","font-size":".85rem","text-align":"center"}},te={class:"card editor-panel"},ne={key:0,class:"empty-editor text-muted"},se={class:"editor-header flex items-center justify-between",style:{"margin-bottom":".75rem"}},ae={style:{flex:"1","margin-right":"1rem"}},oe={class:"flex gap-2 items-center",style:{"margin-top":".35rem"}},ie={class:"quality-indicator"},le={class:"flex gap-2"},re=["disabled"],de={class:"editor-footer flex items-center justify-between"},ce={class:"text-muted",style:{"font-size":".75rem"}},ue={class:"text-muted",style:{"font-size":".75rem"}},ve=U({__name:"KnowledgePage",setup(pe){const{api:g}=M(),_=O(),m=l(!1),y=l(!1),o=l([]),a=l(null),u=l(""),v=l(""),p=l(""),r=l(""),C=[{id:"doc-001",title:"GDPR Data Retention Policy",category:"Compliance",lastUpdated:"2026-03-20",qualityScore:92,content:`# GDPR Data Retention Policy
